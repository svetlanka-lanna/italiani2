<div class="modal modal-address modal-address--new">
		...
		<div class="row">
			<div class="col-sm-6 modal-address__left">
				...
				<div class="form-radio">
					<input type="radio" data-toggle="card-form-1" name="order-address-delivery" id="order-address-delivery-old" value="old" checked="">
					<label for="order-address-delivery-old">ул. Кременчугская, д. 13, последний подъезд, последний этаж, кв. 8 </label>
				</div>
				<div class="form-radio">
					<input type="radio" data-toggle="new-address-form" data-toggle="card-form-1" name="order-address-delivery" id="order-address-delivery-new" value="new">
					<label for="order-address-delivery-new">Добавление нового адреса </label>
				</div>
				<form id="new-address-form" data-hidden="order-address-delivery-new">
					<div class="row">
						<div class="col-8">
							<input type="text" class="form-control" placeholder="Улица*" required>
						</div>
						<div class="col-4">
							<input type="text" placeholder="Дом*" class="form-control" required>
						</div>
					</div>
					<div class="row">
						<div class="col-3">
							<input type="text" required placeholder="Кв. / офис*" class="form-control">
						</div>
						<div class="col-3">
							<input type="text" placeholder="Подъезд" class="form-control">
						</div>
						<div class="col-3">
					...
					<div class="row">
						<div class="col-12">
							<input type="text" placeholder="Название адреса" class="form-control">
						</div>
						<div class="modal-address__notice">
					...
					<div class="row">
						<div class="col-12">
							<textarea name="" id="" class="form-control" placeholder="Комментарий к адресу"></textarea>
						</div>
					</div>
