<div class="modal modal-address modal-address--default">
		...
		<div class="row">
			<div class="col-sm-6 modal-address__left">
				...
				<form>
						...
						<div class="col-12">
							<div class="modal-address__notice">
								<div class="modal-address__notice-success">
									...
									Минимальная сумма доставки - 800 руб. <br>
									Время доставки: ~ 60 мин
								</div>
					...
					<button type="submit" disabled>Сохранить адрес</button>
				</form>
			</div>
