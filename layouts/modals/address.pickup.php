<div class="modal modal-address modal-address--pickup">
		...
		<div class="row">
			<div class="col-sm-6 modal-address__left">
				...
				<div class="pickup">
					<div class="item">
						<div class="block">
							<div class="title">СПб, Невский пр., 65, метро Маяковская</div>
							<div class="time">09:00 — 0:00</div>
						</div>
						<div class="icon">
					...
					<div class="item">
						<div class="block">
							<div class="title">СПб, Коломяжский пр., 17/2, метро Пионерская</div>
							<div class="time">09:00 — 0:00</div>
						</div>
						<div class="icon">
							<img src="img/check.svg" alt="">
